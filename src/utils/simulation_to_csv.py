...
class SimulationToCSVConverter:
    ...
    def __init__(self,
        ...
        self.position_scale = scale  # For coordinate transformation (keeps vehicles in bounds)
        self.bbox_pixels_per_meter = 14.0  # For bounding box size (makes cars visible)
